...
export default function DiagnosticLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a] selection:bg-[#0284c7] selection:text-white pb-24 sm:pb-16">
      ...
      {/* 2. RESTRUCTURED HERO SECTION WITH BALANCED FONT SIZES */}
      <section className="relative min-h-[92vh] flex flex-col justify-between pt-6 pb-8 px-4 sm:px-6 overflow-hidden">
      ...
      {/* 3. BLOCK 2: STATIC PAIN POINTS LIST (NON-CLICKABLE BULLETS) */}
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center pt-2">
            <motion.button
              whileTap={{ scale: 0.96 }}
              onClick={handleOpenModal}
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-[#0284c7] to-[#0369a1] text-white font-bold text-base sm:text-lg shadow-xl glow-primary uppercase tracking-wide"
            >
            ...
            {realCaseGalleries.map((cs) => (
              ...
              >
                ...
                <div className="p-5 space-y-2 bg-white">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-medium">{cs.desc}</p>
