...
export const metadata: Metadata = {
  ...
  description:
    "Перший результат вже за 7 днів без виснажливих тренувань та обмежень в їжі за перевіреною системою від фітнес-тренерки Анастасії Сич. Старт 27.08 | 6 практичних уроків.",
  openGraph: {
    title: "Міні-курс: Отримай плаский живіт та струнку талію | Анастасія Сич",
    description:
      "Перший результат вже за 7 днів без виснажливих тренувань та обмежень в їжі за перевіреною системою від фітнес-тренерки Анастасії Сич. Старт 27.08 | 6 практичних уроків.",
